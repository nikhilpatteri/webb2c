angular.module('batsconfig', ['ngRoute'])
  .config(function ($routeProvider, $locationProvider, PageConfig, $httpProvider, Constants) {
    ...
    $routeProvider
    .when('/b2c_web/', {
        templateUrl: 'component/livetracking/livetracking-new.html',
        controller: 'LiveTrackingCtrl',
        cache: false
    })
    
    .when('/b2c_web/replay', {
        templateUrl: 'component/replayroutedetail/replayroutedetail-new.html',
    ...
    //     url: '/login',
    //     cache: false,
    //     templateUrl: 'component/login/login-new.html',
